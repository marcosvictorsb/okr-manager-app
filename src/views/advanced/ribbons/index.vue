      ...
      <b-col md="6" lg="6">
        <b-card no-body>
          <div class="ribbon4 rib4-blue">
            <span class="ribbon4-band ribbon4-band-blue text-white text-center"
              >50% off</span
            >
          </div>
            ...
            <b-row>
              <div class="col-auto">
                <img
                  ...
                  alt="user"
                  height="150"
                  class="align-self-center shadow-sm mb-3 mb-lg-0"
                />
              </div>
              <div class="col align-self-center">
                <p class="font-18 fw-semibold mb-2">
                  Dastyle - Admin & Dashboard Template
                </p>
                <p class="text-muted">
                  Dastyle is a Bootstrap admin dashboard, It is fully responsive
                  and included awesome features to help build web applications
                  fast and easy.
                </p>
                <a href="#" class="btn btn-primary btn-sm mb-1">Live Priview</a>
                {{ " " }}
          ...
          <b-card-body class="position-relative">
            <b-row>
              ...
              <div class="col align-self-center">
                ...
                <p class="text-muted">
                  Crovex is a Bootstrap admin dashboard, It is fully responsive
                  and included awesome features to help build web applications
                  fast and easy.
                </p>
                <a href="#" class="btn btn-primary btn-sm mb-1">Live Priview</a>
      ...
      <b-col md="6" lg="6">
        <b-card no-body>
          <div class="ribbon1 rib1-danger">
            <span class="text-white text-center rib1-danger">50% off</span>
          </div>
          <b-card-body class="position-relative">
            <b-row>
              <div class="col-auto">
                <img
                  ...
                  alt="user"
                  height="150"
                  class="align-self-center mb-3 shadow-sm mb-lg-0"
                />
              </div>
              <div class="col align-self-center">
                <p class="font-18 fw-semibold mb-2">
                ...
                <p class="text-muted">
                  Metrica is a Bootstrap admin dashboard, It is fully responsive
                  and included awesome features to help build web applications
                  fast and easy.
                </p>
                <a href="#" class="btn btn-primary btn-sm mb-1">Live Priview</a>
          ...
          <b-card-body class="position-relative">
            <b-row>
              ...
              <div class="col align-self-center">
                ...
                <p class="text-muted">
                  Frogetor is a Bootstrap admin dashboard, It is fully
      ...
      <b-col md="6" lg="6">
        <b-card no-body>
          <div class="ribbon2 rib2-warning">
            <span class="text-white text-center rib3-warning fs-11"
              >50% off</span
            >
          </div>
          <b-card-body class="position-relative">
