    ...
    <b-card no-body>
      <b-card-header>
        <b-row class="align-items-center">
          <div class="col">
            <b-card-title>Customers Data</b-card-title>
          </div>
          <div class="col-auto">
...
import { customerStats } from "@/views/apps/analytics/customers/components/data";
import StatCard from "@/views/apps/analytics/customers/components/StatCard.vue";
</script>
